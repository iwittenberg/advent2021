...
abstract class Day1Part(part: Int, testCaseAnswer: List<Long>, previouslySubmittedAnswer: Long? = null) :
...
@RunThis
class Day1Part1 : Day1Part(1, listOf(514579), 100419) {
...
@RunThis
class Day1Part2 : Day1Part(2, listOf(241861950), 265253940) {
    override fun solve(input: Set<Int>): Long {
        input.forEach { first ->
