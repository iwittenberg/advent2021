...
abstract class Day3Part(part: Int, testCaseAnswer: List<Long>, previouslySubmittedAnswer: Long? = null) :
...
@RunThis
class Day3Part1 : Day3Part(1, listOf(7), 242) {
...
@RunThis
class Day3Part2 : Day3Part(2, listOf(336), 2265549792) {
    override fun solve(input: Grid<Char>): Long {
