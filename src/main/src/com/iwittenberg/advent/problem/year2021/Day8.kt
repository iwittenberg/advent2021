...
abstract class Day8Part(part: Int, testCaseAnswer: List<Int>, previouslySubmittedAnswer: Int? = null) :
...
@RunThis
class Day8Part1 : Day8Part(1, listOf(26), 514) {
...
@RunThis
class Day8Part2 : Day8Part(2, listOf(61229), 1012272) {
    override fun solve(input: List<SegmentOutput>): Int {
        var total = 0
        input.forEach { line ->
